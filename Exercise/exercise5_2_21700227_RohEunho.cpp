...
int main(){
    ...
    {
        cout << "\n-- Menu --\n\n";
        cout << "1. Insert a element into heap\n";
        cout << "2. Delete the root element\n";
        //현재 원소 수 및  root 원소 조회
        cout << "3. Numbers of the current elements and Print root element\n";
        //4. 종료
        cout << "4. Quit\n\n";
        ...
        if (com == 1)
        {
            ...
            h1.insert_heap(temp);
            cout << "\nData was inseted into heap.\n";
        }
        else if (com == 2)
        {
            element temp = h1.delete_heap();
            cout << "\nThe root node was deleted.\n";
            cout << "Deleted node's student's name is " << temp.name << ".";
            cout << "\nDeleted node's student's score is " << temp.score << ".\n";
        }
        else if (com == 3)
        {
            //현재 원소 수 및  root 원소 조회
            ...
            double score;
            int hsize=h1.h_size();
            element temp=h1.get_root();
            name=temp.name;
            score= temp.score;
            cout << "\nNumber of elements: " << hsize << '\n';
            cout << "The Name of the root: " << name << '\n';

            cout << "The Score of the root: " << score << '\n';
